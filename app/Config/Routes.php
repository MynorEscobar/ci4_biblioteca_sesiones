...
//PRESTAMOS
$routes->get('listar_prestamos','Prestamos::listarPrestamos2');
//ejemplo realizado en clase
$routes->get('listar_prestamos2','Prestamos::listarDatosPrestamos');

$routes->get('cerrar_sesion','Usuarios::cerrarSesion');
